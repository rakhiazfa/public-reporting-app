            ...
            <x-cube.card title="Filter">
                <form class="-mt-2 flex items-center gap-5" method="GET">
                    <div class="form-group">
                        <input type="text" class="field rounded" name="q" value="{{ request()->get('q') }}" placeholder="Cari instansi . . .">
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-actions">
                                        ...
                                        <form action="{{ route('societies.destroy', ['society' => $society]) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
